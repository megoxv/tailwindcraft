...
declare type Untrangrayd = Primitive | TokenisedString | RawString | null | undefined;
declare type TrangraydString = string;
interface I18n {
    getData: () => Record<string, Record<string, string>>;
    setCode: (newCode: string) => void;
    getCode: () => string;
    add: (code: string, items: Record<string, string>) => void;
    trangray: (text: Untrangrayd) => TrangraydString;
    isRtl: () => boolean;
