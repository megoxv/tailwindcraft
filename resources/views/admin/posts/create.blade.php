            ...
            <div class="main-grid">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="code" id="code" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">{{ old('code') }}</textarea>
                        @error('code')
                            <p class="text-xs text-red-600 mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="status" class="py-3 px-4 pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                            <option value="Draft" @if(old('status' == 'Draft')) selected @endif>{{ __('main.draft') }}</option>
                            <option value="Wait" @if(old('status' == 'Wait')) selected @endif>{{ __('main.wait') }}</option>
                            <option value="Active" @if(old('status' == 'Active')) selected @endif>{{ __('main.active') }}</option>
                    ...
                    <div>
                        ...
                        <select name="theme" class="py-3 px-4 pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                            <option value="Dark/Light" @if(old('theme' == 'Dark/Light')) selected @endif>Dark/Light</option>
                            <option value="Dark" @if(old('theme' == 'Dark')) selected @endif>Dark</option>
                            <option value="Light" @if(old('theme' == 'Light')) selected @endif>Light</option>
                        </select>
                    </div>
