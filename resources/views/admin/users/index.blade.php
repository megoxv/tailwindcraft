...
@section('content')
    <div class="px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="flex justify-between mb-8">
            <div>
                <h2 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-200">{{ __('main.users') }}</h2>
            </div>
            @can('users-create')
            <button class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800" data-hs-overlay="#add-user">
        ...
        @foreach ($users as $user)
            {{-- Create --}}
            @can('users-create')
                <div id="add-user" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
                    <div
                                ...
                                <div class="p-4 sm:p-10 overflow-y-auto">
                                    <div class="mb-6 text-center">
                                        ...
                                        <p class="text-gray-500">
                                            {{ __('main.here_you_can_add_your_new_user') }}
                                        </p>
                                    </div>
                                    <div class="space-y-4">
                                        <div>
                                        ...
                                        <div>
                                            <label for="password" class="block text-sm mb-2 dark:text-white">{{ __('main.password') }}</label>
                                            <div class="relative">
                                        ...
                                        <div>
                                            <label for="status" class="block text-sm mb-2 dark:text-white">{{ __('main.role') }}</label>
                                            <div class="relative">
                                        ...
                                        <div>
                                            <label for="status" class="block text-sm mb-2 dark:text-white">{{ __('main.status') }}</label>
                                            <div class="relative">
                                                <select name="status" id="status"
                                                    class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                                    <option value="1" @if (old('status' == 1)) selected @endif>{{ __('main.active') }}</option>
                                                    <option value="0" @if (old('status' == 0)) selected @endif>{{ __('main.blocked') }}</option>
                                                </select>
                                            </div>
                                            @error('status')
                                                <p class="hidden text-xs text-red-600 mt-2">{{ $message }}</p>
                                        ...
                                        <div>
                                            <label for="status" class="block text-sm mb-2 dark:text-white">{{ __('main.bio') }}</label>
                                            <textarea name="bio"
                                                class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="absolute top-2 right-2">
                                <button type="button"
                                    class="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-sm dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800"
                                    data-hs-overlay="#view-details-{{ $user->id }}">
                                    <span class="sr-only">Close</span>
                                    <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="p-4 sm:p-10 overflow-y-auto">
                                <div class="mb-6 text-center">
                                    <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-gray-200">
                                        {{ __('main.user_information') }}
                                    </h3>
                                </div>

                                <div class="space-y-4">
                                    <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800"
                                        src="{{ $user->getProfilePhoto() }}" alt="{{ $user->name }}">
                                    <div class="flex items-center gap-3">
                                        <h4 class="font-medium text-gray-800 dark:text-gray-200">{{ __('main.name') }}: </h4>
                                    ...
                                    <div class="flex items-center gap-3">
                                        <h4 class="font-medium text-gray-800 dark:text-gray-200">{{ __('main.role') }}: </h4>
                                        <p class="text-sm dark:text-white">{{ $user->getRoleNames()->first() }}</p>
                                    </div>
                                    <div class="flex items-center gap-3">
                                        <h4 class="font-medium text-gray-800 dark:text-gray-200">{{ __('main.status') }}: </h4>
                                        <div>
                                            @if ($user->status == 1)
                                                <span
                                    ...
                                    <div class="flex items-center gap-3">
                                        <h4 class="font-medium text-gray-800 dark:text-gray-200">{{ __('main.date_created') }}: </h4>
                                        <p class="text-sm dark:text-white">
                                            {{ \Carbon\Carbon::parse($user->created_at)->format('m/d/Y') }}</p>
                                    </div>
                                    <div class="flex items-center gap-3">
                                        <h4 class="font-medium text-gray-800 dark:text-gray-200">{{ __('main.last_updated_at') }}: </h4>
                                        <p class="text-sm dark:text-white">
                                            {{ \Carbon\Carbon::parse($user->updated_at)->format('m/d/Y') }}</p>
                                    </div>
                                    <div class=" gap-3">
                                        <h4 class="font-medium text-gray-800 dark:text-gray-200">{{ __('main.bio') }}: </h4>
                                        <p class="text-sm dark:text-white">{{ $user->bio }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="absolute top-2 right-2">
                                <button type="button"
                                    class="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-sm dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800"
                                    data-hs-overlay="#update-{{ $user->id }}">
                                    <span class="sr-only">Close</span>
                                    <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <form action="{{ route('admin.users.update', $user) }}" method="POST"
                                ...
                                <div class="p-4 sm:p-10 overflow-y-auto">
                                    <div class="mb-6 text-center">
                                        ...
                                        <p class="text-gray-500">
                                            {{ __('main.here_you_can_edit_user') }}
                                        </p>
                                    </div>
                                    <div class="space-y-4">
                                        <div class="w-full text-center">
                                            <img class="inline-block h-24 w-h-24 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ $user->getProfilePhoto() }}" alt="{{ $user->name }}">
                                        </div>
                                        <input type="file" alt="image" name="profile_photo" id="image" class="block w-full border border-gray-200 shadow-sm rounded-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-900 dark:border-gray-700 dark:text-gray-400 file:bg-transparent file:border-0 file:bg-gray-100 file:mr-4 file:py-3 file:px-4 dark:file:bg-gray-700 dark:file:text-gray-400">
                                        <div>
                                            <label for="name" class="block text-sm mb-2 dark:text-white">{{ __('main.name') }}</label>
                                            <div class="relative">
                                                <input type="text" id="name" name="name"
                                        ...
                                        <div>
                                            <label for="new_password" class="block text-sm mb-2 dark:text-white">{{ __('main.new_password') }}</label>
                                            <div class="relative">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <select name="status" id="status"
                                                    class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                                    <option value="1" @if ($user->status == 1) selected @endif>{{ __('main.active') }}</option>
                                                    <option value="0" @if ($user->status == 0) selected @endif>{{ __('main.blocked') }}</option>
                                                </select>
                                            </div>
                                            @error('status')
                                                <p class="hidden text-xs text-red-600 mt-2">{{ $message }}</p>
                                        ...
                                        <div>
                                            <label for="status" class="block text-sm mb-2 dark:text-white">{{ __('main.bio') }}</label>
                                            <textarea name="bio" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" rows="3">{{ $user->bio }}</textarea>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="absolute top-2 right-2">
                                <button type="button"
                                    class="inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-sm dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800"
                                    data-hs-overlay="#delete-{{ $user->id }}">
                                    <span class="sr-only">Close</span>
                                    <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="p-4 sm:p-10 overflow-y-auto">
                                <div class="flex gap-x-4 md:gap-x-7">
                                    ...
                                    <div class="grow">
                                        <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-gray-200">
                                            {{ __('main.delete_personal_account') }}
                                        </h3>
                                        <p class="text-gray-500">
                                            {{ __('main.delete_personal_account_message_alert') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
